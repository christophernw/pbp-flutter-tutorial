import 'package:labflutterchristo/main.dart';
import 'package:flutter/material.dart';
import 'package:labflutterchristo/model/to_do.dart';
...
class _MyFormPageState extends State<MyFormPage> {
  ...
  showJenjang() {
    if (jenjangSarjana) {
      return Text("Jenjang: Sarjana");
    } else if (jenjangDiploma) {
      return Text("Jenjang: Diploma");
    } else if (jenjangMagister) {
      return Text("Jenjang: Magister");
    } else {
      return Text("Jenjang: Doktor");
    }
  }
